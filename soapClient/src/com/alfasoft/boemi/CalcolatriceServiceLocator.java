...
public class CalcolatriceServiceLocator extends org.apache.axis.client.Service implements com.alfasoft.boemi.CalcolatriceService {
    ...
    private java.lang.String Calcolatrice_address = "http://localhost:5050/SoapProgetto/services/Calcolatrice";
    ...
    public com.alfasoft.boemi.Calcolatrice getCalcolatrice() throws javax.xml.rpc.ServiceException {
    ...
    public com.alfasoft.boemi.Calcolatrice getCalcolatrice(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.alfasoft.boemi.CalcolatriceSoapBindingStub _stub = new com.alfasoft.boemi.CalcolatriceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.alfasoft.boemi.Calcolatrice.class.isAssignableFrom(serviceEndpointInterface)) {
                com.alfasoft.boemi.CalcolatriceSoapBindingStub _stub = new com.alfasoft.boemi.CalcolatriceSoapBindingStub(new java.net.URL(Calcolatrice_address), this);
                _stub.setPortName(getCalcolatriceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://boemi.alfasoft.com", "CalcolatriceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://boemi.alfasoft.com", "Calcolatrice"));
        }
